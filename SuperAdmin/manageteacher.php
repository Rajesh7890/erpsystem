    ...
    if(@$_GET['regd_no']) {
        ...
        while($row1 = mysqli_fetch_array($execute_query1)) {
            ...
            <div class="widget-content nopadding">
              <form action="manageteacher.php" method="post" class="form-horizontal">
        ...
        <div class="widget-content nopadding">
          <form action="manageteacher.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Regd No :</label>
              <div class="controls">
                <input type="text" class="span11" name="regd_no" pattern="[A-Za-z0-9].{11}" required title="Registration number must be a 10 number"/>
              </div>
            </div>
