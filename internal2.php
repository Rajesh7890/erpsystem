...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="lecture.php"><i class="icon icon-copy"></i> <span>Lectures Note</span></a></li>
          ...
          <div id="tab1" class="tab-pane active">
            ...
            <table class="table table-bordered table-striped">
              <thead>
                  ...
                  <?php
                      if($_SESSION['sem']) {
                          $query = "SELECT * FROM subjects WHERE sem = '{$_SESSION['sem']}'";
              ...
              <tbody>
                  <?php
                  if($_SESSION['sem']=='8th'){
                      $query = "SELECT * FROM exams WHERE regd_no = '{$_SESSION['regd_no']}' and internal = '1st'";
                      $execute_query = mysqli_query($connection,$query);
          ...
          <div id="tab2" class="tab-pane">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                  if($_SESSION['sem']=='8th'){
                      $query = "SELECT * FROM exams WHERE regd_no = '{$_SESSION['regd_no']}' and internal = '2nd'";
                      $execute_query = mysqli_query($connection,$query);
